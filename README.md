      ...
      >
        <title id="titleId">Xpertgarrett's GitHub Stats, Rank: A+</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2022 : 0, Total PRs: 0, Total Issues: 0, Contributed to: 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 128.26253310305907;
      }
    }
    ...
    @keyframes fadeInAnimation {
      ...
      <text
        ...
        class="header"
        data-testid="header"
      >Xpertgarrett's GitHub Stats</text>
    </g>
      </g>
